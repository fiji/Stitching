...
public class CommonFunctions
{
	...
	public static String[] fusionMethodList = { "Linear Blending", "Average", "Median", "Max. Intensity", "Min. Intensity", "Overlap", "Overlay into composite image", "Do not fuse images" };	
	public static String[] fusionMethodListSimple = { "Overlay into composite image", "Do not fuse images" };	
	public static String[] fusionMethodListGrid = { "Linear Blending", "Average", "Median", "Max. Intensity", "Min. Intensity", "Overlap (use image intensity from one tile)", /* "Overlay into composite image", */ "Do not fuse images (only write TileConfiguration)" };	
